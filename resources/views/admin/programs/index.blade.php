<x-layouts.admin title="Programs">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-xl font-semibold text-white">Programs</h1>
        <a href="{{ route('admin.programs.create') }}" class="btn-primary text-sm">+ New Program</a>
    </div>
    @if(session('status'))
...
@endcan
                ...
                @empty
                <tr><td colspan="6" class="px-3 py-6 text-center text-slate-500">No programs found.</td></tr>
                @endforelse
            </tbody>
        </table>
