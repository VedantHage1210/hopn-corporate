<x-layouts.admin title="Innovation Domains">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-xl font-semibold text-white">Innovation Domains</h1>
        <a href="{{ route('admin.innovation-domains.create') }}" class="btn-primary text-sm">+ New Domain</a>
    </div>
    @if(session('status'))
        ...
        <table class="min-w-full text-sm text-slate-300">
            ...
            <tbody>
                ...
                <tr class="border-t border-slate-800 hover:bg-slate-800/30">
                    ...
                    <td class="px-3 py-3"><x-admin.translation-status :item="$domain" :fields="['name']" /></td>
...
@endcan
                ...
                @empty
                <tr><td colspan="7" class="px-3 py-6 text-center text-slate-500">No domains found.</td></tr>
                @endforelse
            </tbody>
        </table>
