...
<div id="success-toast" style="display:flex; position:fixed; top:24px; right:24px; z-index:2000; align-items:center; gap:12px; background:#111827; border:1px solid rgba(16,185,129,0.4); border-radius:12px; padding:16px 20px; box-shadow:0 8px 32px rgba(0,0,0,0.4); max-width:380px;">
    ...
    <button onclick="document.getElementById('success-toast').style.display='none'"
            style="margin-left:auto; background:none; border:none; color:#64748B; cursor:pointer; font-size:18px;">×</button>
</div>
@endif
...
<section style="padding:80px 0; background:#030712;">
    <div class="container-shell">
        ...
        <div id="events-grid" style="display:grid; grid-template-columns:repeat(auto-fill,minmax(320px,1fr)); gap:20px;">
            ...
            <div class="event-card"
                ...
                <div style="padding:24px; display:flex; flex-direction:column; flex:1; gap:14px;">
                    ...
                    {{-- Description --}}
                    @if($desc)
                    <p style="font-size:13px; color:#64748B; line-height:1.7; margin:0;">{{ Str::limit($desc, 110) }}</p>
                    @endif
                    ...
                    <div>
                        <div style="font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:#334155; margin-bottom:6px;">
                    ...
                    <div style="margin-top:auto; padding-top:16px; border-top:1px solid rgba(255,255,255,0.05);">
                        ...
                        @else
                        <span style="display:inline-flex; align-items:center; padding:10px 20px; border-radius:8px; background:rgba(255,255,255,0.04); color:#475569; font-size:13px; font-weight:600; border:1px solid rgba(255,255,255,0.06);">
        ...
        <div style="text-align:center; padding:100px 40px; color:#334155;">
            ...
            <p style="font-size:16px; color:#334155; max-width:400px; margin:0 auto;">
    ...
    <div class="container-shell">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(250px,1fr)); gap:16px;">
            ...
            <div class="hopn-lift-card" style="position:relative; border:1px solid rgba(255,255,255,0.06); background:#0A0F1E; border-radius:16px; padding:28px; transition:all 0.25s; overflow:hidden;">
                ...
                <p style="font-size:13px; color:#475569; line-height:1.7;">{{ $format['desc_'.$lang] ?? $format['desc_en'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('leads.event-registration', ['lang'=>$lang]) }}">
                ...
                <div style="display:grid; gap:14px;">
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                        <div>
                            <label style="display:block; font-size:12px; font-weight:600; color:#64748B; margin-bottom:6px; text-transform:uppercase; letter-spacing:0.06em;">
                    ...
                    <div style="display:flex; align-items:flex-start; gap:10px;">
                        ...
                        <label for="gdpr_event" style="font-size:12px; color:#475569; line-height:1.6;">
