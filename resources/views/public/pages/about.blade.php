...
<section style="position:relative; overflow:hidden; background:#030712; min-height:70vh; display:flex; align-items:center;">
    ...
    <div class="container-shell" style="position:relative; z-index:10; padding:80px 0; text-align:center;">
        ...
        <p style="font-size:clamp(16px,2vw,20px); color:#64748B; max-width:640px; margin:0 auto 48px; line-height:1.7;">
    ...
    <div class="container-shell">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:80px; align-items:center;">
            <div>
                ...
                <p style="font-size:16px; color:#64748B; line-height:1.8; margin-bottom:20px;">
                ...
                <p style="font-size:16px; color:#64748B; line-height:1.8;">
    ...
    <div class="container-shell">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill,minmax(220px,1fr)); gap:16px;">
            ...
            <div style="border:1px solid rgba(255,255,255,0.06); background:#0A0F1E; border-radius:16px; padding:28px; text-align:center; transition:all 0.25s; position:relative; overflow:hidden;"
                ...
                @if($bio)
                <p style="font-size:12px; color:#475569; line-height:1.6;">{{ Str::limit($bio,80) }}</p>
                @endif
                @if($member->linkedin)
    ...
    <div class="container-shell">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(280px,1fr)); gap:16px;">
            ...
            <div style="position:relative; border:1px solid rgba(255,255,255,0.06); background:#0A0F1E; border-radius:16px; padding:28px; transition:all 0.25s; overflow:hidden;"
                ...
                <p style="font-size:13px; color:#475569; line-height:1.7;">{{ $v['desc_'.$lang] ?? $v['desc_en'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
