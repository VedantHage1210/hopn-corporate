        ...
        <div class="container-shell" style="position:relative; z-index:10;">
            ...
            <div style="display:flex; flex-wrap:wrap; gap:12px;">
                ...
                <a href="{{ route('contact.index', ['lang' => $lang]) }}"
                   style="display:inline-flex; align-items:center; gap:8px; padding:12px 28px; border-radius:10px; border:1px solid rgba(255,255,255,0.12); background:rgba(255,255,255,0.05); color:white; font-size:14px; font-weight:600; text-decoration:none;"
